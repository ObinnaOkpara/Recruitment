...
class NavBar extends React.Component {
  render() {
    return (
      <div className="rd-navbar-wrap" style={{ height: "110px" }}>
        <nav
            ...
            <div className="rd-navbar-main">
                  ...
                  <ul className="rd-navbar-nav">
                    <li className="rd-nav-item rd-navbar--has-dropdown rd-navbar-submenu">
                      ...
                      <ul className="rd-menu rd-navbar-dropdown">
                        ...
                        <li className="rd-dropdown-item">
                          <a className="rd-dropdown-link" href="companies.html">
                            Companies
                          </a>
                        </li>
                        <li className="rd-dropdown-item">
                      ...
                      <ul className="rd-menu rd-navbar-megamenu rd-navbar-open-right">
                        <li className="rd-megamenu-item">
                          <h6 className="rd-megamenu-title">
                            <a href="https://livedemo00.template-help.com/wt_prod-20039/pages-1.html">
                              Pages 1
                            </a>
                          </h6>
                        ...
                        <li className="rd-megamenu-item">
                          <h6 className="rd-megamenu-title">
                            <a href="https://livedemo00.template-help.com/wt_prod-20039/pages-2.html">
                              Pages 2
                            </a>
                          </h6>
                          <ul className="rd-megamenu-list">
                        ...
                        <li className="rd-megamenu-item">
                          <h6 className="rd-megamenu-title">
                            <a href="https://livedemo00.template-help.com/wt_prod-20039/elements.html">
                              Elements
                            </a>
                          </h6>
                          <ul className="rd-megamenu-list">
              ...
              <div className="rd-navbar-aside">
                <div className="rd-navbar-aside-item">
                  <button
                    className="button button-xs button-primary-outline button-icon button-icon-left rd-navbar-popup-toggle toggle-original"
                    data-rd-navbar-toggle="#rd-navbar-register"
                  >
                    <span className="icon mdi mdi-account"></span>Sign Up
                  </button>
                  <div
                    className="rd-navbar-popup bg-gray-100 toggle-original-elements"
                  ...
                  >
                    ...
                    <form
                      ...
                      method="post"
                      action="https://livedemo00.template-help.com/wt_prod-20039/bat/rd-mailform.php"
                ...
                <div className="rd-navbar-aside-item">
                  <button
                    className="button button-xs button-primary button-icon button-icon-left rd-navbar-popup-toggle toggle-original"
                    data-rd-navbar-toggle="#rd-navbar-login"
                  >
                    <span className="icon mdi mdi-import"></span>Login
                  </button>
                  <div
                    className="rd-navbar-popup bg-gray-100 toggle-original-elements"
                    id="rd-navbar-login"
